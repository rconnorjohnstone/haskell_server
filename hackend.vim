...
setlocal fdn=10
setlocal nofen
let s:l = 53 - ((0 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
setlocal fdn=10
setlocal nofen
let s:l = 36 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal fdn=10
setlocal nofen
let s:l = 48 - ((32 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal fdn=10
setlocal nofen
let s:l = 46 - ((45 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal fdn=10
setlocal nofen
let s:l = 67 - ((15 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
