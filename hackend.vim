...
badd +0 templates/footer/footer.cassius
badd +0 src/Handler/About.hs
badd +1 templates/navbar/navbar.hamlet
badd +0 templates/navbar/navbar.cassius
argglobal
%argdel
$argadd app/main.hs
set stal=2
...
setlocal fdn=10
setlocal nofen
let s:l = 36 - ((0 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal fdn=10
setlocal nofen
let s:l = 48 - ((20 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal fdn=10
setlocal nofen
let s:l = 82 - ((5 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
82
...
setlocal fdn=10
setlocal nofen
let s:l = 14 - ((0 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
...
setlocal fdn=10
setlocal nofen
let s:l = 15 - ((8 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
...
setlocal fdn=10
setlocal nofen
let s:l = 36 - ((30 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 129 + 116) / 233)
exe 'vert 2resize ' . ((&columns * 136 + 116) / 233)
argglobal
setlocal fdm=syntax
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fdn=10
setlocal nofen
let s:l = 62 - ((14 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 132 + 116) / 233)
