...
setlocal fdn=10
setlocal fen
let s:l = 16 - ((12 * winheight(0) + 27) / 55)
...
setlocal fdn=10
setlocal nofen
let s:l = 15 - ((11 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
...
setlocal fdn=10
setlocal nofen
let s:l = 36 - ((0 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal fdn=10
setlocal nofen
let s:l = 62 - ((0 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
